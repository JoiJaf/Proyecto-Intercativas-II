        ...
        <div className="flex items-center">{/* Contenedor de elementos de navegacion */}
          ...
          <div className={`lg:hidden ${isOpen ? 'block' : 'hidden'}`}>
            ...
            <div className="fixed inset-y-0 right-0 z-50 bg-[#0E0E0E] w-64 flex flex-col py-4">
              ...
              <a href="/notificationPage" class="text-gray-200 hover:text-gray-700 dark:text-gray-200 hover:bg-gray-100 py-2 px-6 flex items-center transition-colors duration-300 transform rounded-md hover:rounded-md dark:hover:bg-gray-700">
              ...
              <a href="/schedulePage" class="text-gray-200 hover:text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 py-2 px-6 flex items-center transition-colors duration-300 transform rounded-md hover:rounded-md">
