...
export function Settings() {
    return (
      ...
      <section className='grid m-4 justify-center items-center'>
          <h2 className="my-[38px] ml-[30px] clamp-xxl">Settings</h2>
            <div className="grid text-white gap-[38px]">
                ...
                <div className="bg_banner w-full h-[272px] max-md:h-[600px] rounded-[40px]">
        ...
        <div className='grid grid-cols-2 gap-[38px] max-md:grid-cols-1'>
            <div>
                <img className=' w-full' src="../src/assets/img/contactTeacher.png" alt="contact with the teacher" />
            </div>
