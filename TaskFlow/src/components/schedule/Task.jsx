...
export function Tasks() {
    ...
    return (
        <div className="mt-[1vw] mb-[2rem] mr-[4vw] bg-[#212121] p-[2rem] rounded-[2rem]">
            <h3 className="fs_xl text-[#fff] pb-[1rem] font-semibold">Tasks</h3>

            <div className="grid">
                <div className="border-4 border-[#fff] flex gap-[2vw] items-center mb-[1rem] rounded-[1rem]">
                    <img className="w-[11vw] rounded-[1rem_0_0_1rem]" src="https://biblioteca.acropolis.org/wp-content/uploads/2019/07/Rosa-Mister_Lincoln.jpg" alt="" />
                    <div className="fs_md">
