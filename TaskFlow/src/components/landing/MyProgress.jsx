...
export function MyProgress() {
  return (
    <section className=" bg-white max-w-screen ">
      <div className="">
        <section className="bg_banner rounded-[5rem] grid-cols-[35%_60%] gap-[3rem] p-20 banner-myprogress  mx-[rem] mb-[3rem]">
          <div>
            <h2 class="fs_xl mb-4 text-white font-bold">Pending jobs</h2>
            <p class="fs_xxl mb-4 text-white font-normal">Hello (usuario)</p>

            <h3 class="fs_lg text-white">
              This week you have <br />
              <span className="pt-4 fs_xxl font-semibold">10 tasks</span>{" "}
            </h3>
            <button class="flex py-2 px-10 mt-[4vw] bg-[#6BDD8F] fs_md items-center rounded-3xl">
              View all{" "}
              <svg
          ...
          <div class="flex gap-[1.8rem] ">
            <div class="bg-[#F0EC84] p-[2vw] rounded-[1rem]">
              ...
              <p className="fs_lg font-light w-[8vw] mr-[3vw] mb-2">
            ...
            <div class="bg-[#F0B284] mr-[rem] p-[2vw] rounded-[1rem]">
              <p className="font-bold fs_md mb-[2vw]">03</p>
              <p className="fs_lg font-light w-[8vw] mr-[3vw] mb-2">
                Concept Mapping from Videos
              </p>
              <p className="font-semibold mb-[2vw]">
